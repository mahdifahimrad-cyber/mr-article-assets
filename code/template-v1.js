/* Shared bilingual article behavior. Detects language from .article-container lang/dir. */
(function () {
    ...
    function getPhoneSwipeContainer(target) {
        const trigger = target && target.closest
            ? target.closest('.article-mobile-cta-holder, .article-cta-edge-tabs')
            : null;
